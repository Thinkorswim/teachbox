...
<div style="background:#fff;margin-left:40px; margin-right:40px;">
		...
		<p style="color:#000; padding-left:20px;padding-right:20px">It looks like you have requested a new password. You have to use the following link to activate it. If you have not requested a new password, please ignore this e-mail:</p>
...
<p style="color:#fff">Web: <a style="color:#1abc9c" href="www.teachbox.io">www.teachbox.io</a> | T: +359886 624 880 | E-mail: info@teachbox.io</p>
