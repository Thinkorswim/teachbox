...
<div style="background:#fff;margin-left:40px; margin-right:40px;">
		...
		<p style="color:#000; padding-left:20px;padding-right:20px">Unfortunately your lesson "{{$lesson->name}}" form the course "{{$course->name}}" has not been approved. Some of the reasons that might happen include: unsatisfactory quality, inappropriate content and copyright violation.</p>
		<p style="color:#000; padding-left:20px;padding-right:20px">If you need help for your further courses and lessons check our "How to create a professional online course" course.</p><br><br>
