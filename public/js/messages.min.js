...
function retrieveChatMessages()
{
    $.post('messages/get', {userId: username}, function(data)
    {
        $.each(data, function(index, value) {
            ...
            if(value['sender'] == 0){
                   $('#chat-window').append('<div class="your row"><img class="small-profile" src="' + public_path() + '/img/' + value['id'] +'/' + thumb +'"><div class="your-bubble"> '+ escapeHtml(value['message']) +'</div></div>');  

            }else{
                    $('#chat-window').append('<div class="their row"><img class="small-profile" src="' + public_path() + '/img/' + value['id'] +'/' + thumb +'"><div class="their-bubble">  '+ escapeHtml(value['message']) +'</div></div>');  
            }
